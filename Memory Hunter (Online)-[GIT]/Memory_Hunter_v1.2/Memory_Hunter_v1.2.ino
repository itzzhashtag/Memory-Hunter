...
// ── Simon hardware ───────────────────────────────────────────
const uint8_t BUTTON_PINS[4] = {2, 3, 4, 5};   // Active-LOW buttons
const uint8_t LED_PINS[4]    = {9, 10, 11, 12};   // Game LEDs (PWM-capable)
...
// ── NeoPixel strip ───────────────────────────────────────────
#define NEO_PIN       A0   // Data pin for NeoPixel strip
#define NEO_COUNT     10   // Number of pixels in your strip
